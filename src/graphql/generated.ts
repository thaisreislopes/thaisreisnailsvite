...
export type SubscriberCreateInput = {
  createdAt?: InputMaybe<Scalars['DateTime']>;
  email: Scalars['String'];
  menssage?: InputMaybe<Scalars['String']>;
  name?: InputMaybe<Scalars['String']>;
...
export type SubscriberManyWhereInput = {
  ...
  menssage?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  menssage_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  menssage_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  menssage_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values that are not equal to given value. */
  menssage_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  menssage_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  menssage_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  menssage_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  menssage_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  menssage_starts_with?: InputMaybe<Scalars['String']>;
  name?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  name_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
...
export enum SubscriberOrderByInput {
  ...
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
  MenssageAsc = 'menssage_ASC',
  MenssageDesc = 'menssage_DESC',
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC',
  PhoneAsc = 'phone_ASC',
...
/**
 * __useGetMenusLinktreeQuery__
 *
 * To run a query within a React component, call `useGetMenusLinktreeQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetMenusLinktreeQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetMenusLinktreeQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetMenusLinktreeQuery(baseOptions?: Apollo.QueryHookOptions<GetMenusLinktreeQuery, GetMenusLinktreeQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetMenusLinktreeQuery, GetMenusLinktreeQueryVariables>(GetMenusLinktreeDocument, options);
      }
export function useGetMenusLinktreeLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetMenusLinktreeQuery, GetMenusLinktreeQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetMenusLinktreeQuery, GetMenusLinktreeQueryVariables>(GetMenusLinktreeDocument, options);
        }
export type GetMenusLinktreeQueryHookResult = ReturnType<typeof useGetMenusLinktreeQuery>;
export type GetMenusLinktreeLazyQueryHookResult = ReturnType<typeof useGetMenusLinktreeLazyQuery>;
export type GetMenusLinktreeQueryResult = Apollo.QueryResult<GetMenusLinktreeQuery, GetMenusLinktreeQueryVariables>;