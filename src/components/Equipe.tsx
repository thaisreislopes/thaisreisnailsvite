export function Equipe() {
  return (
    <section className="w-full bg-slate-200">
      <div className="relative transition-all m-auto p-10 w-full max-w-[1180px]">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <ul className="grid grid-cols-3 gap-4">
              <li className="flex flex-col items-center group">
                <img
                  className="rounded-[50%] w-32 h-32 mb-1 group-hover:animate-pulse transition-all"
                  src="/images/equipe/01.jpg"
                  alt=""
                />
                <h3 className="text-lg font-bold">Naiara</h3>
              ...
              <li className="flex flex-col items-center  group">
                <img
                  ...
                  alt=""
                />
                <h3 className="text-lg font-bold">Ivete</h3>
              ...
              <li className="flex flex-col items-center  group">
                <img
                  ...
                  alt=""
                />
                <h3 className="text-lg font-bold">Rose</h3>
                <span className="text-sm">Manicure</span>
              </li>
            </ul>
          </div>
